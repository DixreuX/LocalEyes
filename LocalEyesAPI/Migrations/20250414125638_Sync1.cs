    ...
    public partial class Sync1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MunicipalityUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MunicipalityUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MunicipalityUsers_Municipalities_MunicipalityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MunicipalityReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MunicipalityReports_Municipalities_MunicipalityId",
                        column: x => x.MunicipalityId,
                        principalTable: "Municipalities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MunicipalityReports_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MunicipalityReports_MunicipalityId",
                table: "MunicipalityReports",
                column: "MunicipalityId");

            migrationBuilder.CreateIndex(
                name: "IX_MunicipalityReports_ReportId",
                table: "MunicipalityReports",
                column: "ReportId");

            migrationBuilder.CreateIndex(
                name: "IX_MunicipalityUsers_MunicipalityId",
                table: "MunicipalityUsers",
                column: "MunicipalityId");

            migrationBuilder.CreateIndex(
                name: "IX_MunicipalityUsers_UserId",
                table: "MunicipalityUsers",
                column: "UserId");
